/**
 * Video till utställning 105 Konst i Midsommartid.
 *   node scripts/seed-video-105-midsommartid.mjs
 *
 * https://www.instagram.com/p/DLK8vnXqbdN/
 */
...
const EXHIBITION_ID = 'exhibition.105-konst-i-midsommartid'
const IG = 'https://www.instagram.com/p/DLK8vnXqbdN/'
const VIDEO_ID = 'video.105-konst-i-midsommartid'
...
async function main() {
  ...
  const publishedAt = ex.start ? String(ex.start).slice(0, 10) : '2025-06-20'

  await client.createOrReplace({
    _id: VIDEO_ID,
    _type: 'video',
    title: `${ex.artistLabel || ex.title || 'Konst i Midsommartid'} — video`,
    slug: {_type: 'slug', current: '105-konst-i-midsommartid'},
    url: IG,
    thumbnail,
    description:
      og.description?.slice(0, 280) ||
      'Film från utställningen Konst i Midsommartid på GALLERIett (Instagram).',
    exhibition: {_type: 'reference', _ref: EXHIBITION_ID},
    publishedAt,
  })

  console.log('✓', VIDEO_ID)
  console.log('  Studio:', 'https://galleriett-tjorn.sanity.studio/structure/video')
